...
#cell types plots  FINE LEVELS
  ...
  pdf(file.path(params$datapath,'../results/Figures_Oct2023/Fig3_UMAPs_CTA_normal24.pdf'),width = 12,height = 10.5) 
...
# plots
* Similar to the plots of Lambrechts 2018.
...
pdf(file.path(params$datapath,'../results/Figures_Oct2023/Fig4_barplots_lambrechtsN24.pdf'),width = 11,height = 12) 
