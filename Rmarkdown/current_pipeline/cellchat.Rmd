...
pdf(file.path(params$datapath,'../results/Figures_August2023/cellchat/cellchat_tests.pdf'),width = 9,height = 12) 

((((p_com[[1]]+p_com[[2]])/(p_com[[3]]+p_com[[4]])+ plot_layout(guide ='collect')) | stacked1) + plot_layout(width=c(8,1))) /
  
((plot_spacer() + netMHC) + plot_layout(width=c(8,1))) /
((plot_spacer() + netPTPRM) + plot_layout(width=c(8,1))) 
