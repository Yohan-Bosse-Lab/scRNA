...
#save plot    
pdf(file.path(params$datapath,paste0('../results/Figures_Oct2023/Figure_S3.pdf')),width = 8,height = 4)
cnv_annot_corplot
dev.off()
```
...
#save plot  
pdf(file.path(params$datapath,'../results/Figures_Oct2023/Figure_S2.pdf'),width = 6,height = 4) 
sil_plot
dev.off()
```
