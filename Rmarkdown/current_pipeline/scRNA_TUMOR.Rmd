...
# plots
```{r plots}
 pdf(file.path(params$datapath,'../results/Figures_Oct2023/Figure5_UMAPs_CTA_tumor24.pdf'),width = 12,height = 4.5) 
...
#save plots
pdf(file.path(params$datapath,'../results/Figures_Oct2023/Figure6_barplots_lambrechtsT24.pdf'),width = 14,height = 12) 
